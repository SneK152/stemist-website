    ...
    <Container title="Home">
      <div>
        <Banner image="/homepage2.jpeg" full>
          <h1 className="text-left font-medium font-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl lg:mb-5 max-w-[28ch]">
            Accelerating education with{" "}
            <span className="text-blue">engaging</span> workshops
          </h1>
          <span className="block sm:mb-4 text-lg font-normal text-left sm:text-3xl">
