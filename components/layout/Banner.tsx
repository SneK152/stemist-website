    ...
    <>
      ...
      >
        ...
        <div className="flex h-full w-full items-center justify-center">
          <div
            className={`absolute py-8 flex flex-col justify-center gap-3 overflow-hidden break-words rounded-xl p-4 bg-opacity-20 bg-black text-center text-white backdrop-blur-sm backdrop-brightness-90 z-20 ${
              full
                ? "h-full w-full"
