    ...
    <div className="p-4 m-auto text-center justify-center">
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        <Link href="https://discord.gg/FxABpUX">
          ...
          >
            <Card
              className="flex items-center justify-center flex-col h-full shadow-none"
              title="Bay Area Hackathons"
              image="/partners/logo-BAHackathons-text.png"
            >
              Discord Community for finding and organizing hackathons across the
              Bay Area.
            </Card>
          </a>
        </Link>
        <Link href="https://www.noticebard.com/">
          ...
          >
            <Card
              className="flex items-center justify-center flex-col h-full shadow-none"
              title="NoticeBard"
              image="/partners/noticebard-logo.svg"
            >
